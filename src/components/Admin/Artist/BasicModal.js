...
import { Form, DatePicker, Input, Modal, Select, Row, Col, InputNumber } from 'antd';
        ...
        >
          <Form onSubmit={this.handleSubmit}>
            ...
            <Row>
              ...
              <Col span={12}>
                <Constellation defValue={basicData.constellation} formItemLayout={formItemLayout} form={form}
                               disabled={disabled}/>
              </Col>
            </Row>
